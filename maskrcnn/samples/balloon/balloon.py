...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', required=True, help="Path to weights .h5 file or 'coco'")
    parser.add_argument('--logs', required=False, default=DEFAULT_LOGS_DIR, help='Logs and checkpoints directory (default=logs/)')
    parser.add_argument('--init', default=False, action='store_true', help='Get weights')
    ...
    if args.init:
        # Load pretrained coco model and save weights via pickle to ../../weights/00000.weights
    ...
    try:
        ...
        fs.close()
        model.m_set_weights(weights)
        print('weights successfully loaded')
    except:
        print('Error loading weights, pls run --init before')
