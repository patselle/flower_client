...
#  My Functions
############################################################
# https://github.com/matterport/Mask_RCNN/issues/1318
config = tf.compat.v1.ConfigProto()  
config.gpu_options.allow_growth = True

# limit graphic memory allocation
...
class MaskRCNN(object):
    ...
    def get_hash(self, encoding='sha256'):
        # serialize model weights
        serialized_weights = json.dumps(str(self.m_get_weights()), skipkeys=True).encode()

        # Encoding the string to pass into update()
        enc_alg = hashlib.new(encoding)
        
        #Passing the string into update()
        enc_alg.update(serialized_weights)
        
        # return the new string using hexdigest()
        return enc_alg.hexdigest() 
